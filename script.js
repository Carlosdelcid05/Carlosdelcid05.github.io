...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        en: {
            ...
            project3Title: 'Code Analyzer - Frontend',
            project3Desc: 'Frontend for code analysis connected to backend on port 3000 with execution output, error table, and symbol table.',
        ...
        es: {
            ...
            project3Title: 'Analizador de Código - Frontend',
            project3Desc: 'Frontend para análisis de código conectado al backend en puerto 3000 con salida de ejecución, tabla de errores y tabla de símbolos.',
